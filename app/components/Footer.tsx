export default function Footer(){
    return(
        <footer id="contato" className="mt-16 mb-8">
            <div className="flex justify-center text-xl text-center space-x-4">
                Esse site foi desenvolvido por um Acadêmico da Universidade Federal do Paraná Campus Francisco Beltrão (UTFPR-FB) para um trabalho de conclusão de curso.
