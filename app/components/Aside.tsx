export default function Aside() {
    return (
        <div className="w-1/6 block mb-2 px-4 py-2 bg-gray-300 text-black rounded-md hover:bg-gray-400">
                    ...
                    <a href="/components/paginas/softwaresMatematica" className="block mb-2 px-4 py-2 bg-green-500 text-white rounded-md hover:bg-green-600">Listar Softwares Portugues</a>
